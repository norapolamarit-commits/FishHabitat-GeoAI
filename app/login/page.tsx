  ...
  return (
    <div className="grid min-h-[calc(100vh-4rem)] lg:grid-cols-2">
      ...
      <div className="relative flex items-center justify-center overflow-hidden bg-[#04101C] px-4 py-16 text-white sm:px-6 lg:bg-background lg:text-foreground">
        {/* subtle decorative rectangles, echoing the reference layout — only on wide panels, they overwhelm mobile */}
        <div className="pointer-events-none absolute -right-10 top-10 hidden h-40 w-32 rounded-2xl bg-white/[0.03] lg:block" />
        <div className="pointer-events-none absolute -right-6 bottom-16 hidden h-56 w-28 rounded-2xl bg-accent/5 dark:bg-white/[0.03] lg:block" />
